...
import vn.education.core.common.utils.ExcelPoiUtil;
...
import vn.education.core.service.impl.RoleServiceImpl;
...
public class UserController extends HttpServlet {
    ...
    public final String SHOW_IMPORT_USER = "show_import_user";
    public final String READ_EXCEL = "read_excel";
    public final String VALIDATE_IMPORT = "validate_import";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //FormUtil.populate(UserCommand.class, request) dung de lay tat ca cac tham so trong URL gan cho UserCommand
        //Vi du nhu co userId = 2 thi gan pojo co userId = 2
    ...
    private UserImportDTO readDataFromExcel(Row row) {
        ...
        userImportDTO.setUserName(ExcelPoiUtil.getValueCell(row.getCell(0)));
        userImportDTO.setPassword(ExcelPoiUtil.getValueCell(row.getCell(1)));
        userImportDTO.setFullName(ExcelPoiUtil.getValueCell(row.getCell(2)));
        userImportDTO.setRoleName(ExcelPoiUtil.getValueCell(row.getCell(3)));
