                                ...
                                <div class="col-xs-12">
                                    <div class="widget-box table-filter">
                                        <div class="widget-header">
                                            <h4 class="widget-title"><fmt:message bundle="${lang}" key="label.search" /></h4>
                                            ...
                                            <div class="widget-main">
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label"><fmt:message bundle="${lang}" key="label.guideline.listen.title" /></label>
                                                        <div class="col-sm-8">
                                                            <div class="fg-line">
                                                                <input type="text" name="pojo.title" value="${items.pojo.title}" class="form-control input-sm"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                    ...
                                    <div class="table-btn-controls">
                                        <div class="pull-right tableTools-container">
                                            <div class="dt-buttons btn-overlap btn-group">
                                                <c:url value="/admin-guideline-listen-edit.html" var="addUrl">
                                                    <c:param name="urlType" value="url_edit" />
                                                </c:url>
                            ...
                            <div class="table-responsive">
                                <fmt:bundle basename="ApplicationResource" >
                                    <display:table id="tableList" name="items.listResult" partialList="true"
                                                   size="${items.totalItems}" pagesize="${items.maxPageItems}" sort="external" requestURI="${requestUrl}"
                                                    class="table table-fcv-ace table-striped table-bordered table-hover dataTable no-footer "
                                                    style="margin: 3em 0 1.5em;">
                                        <display:column title="<fieldset class='form-group'>
                                                        <input type='checkbox' id='checkAll' class='check-box-element'>
                                                        </fieldset>" class="center select-cell" headerClass="center select-call">
                                            <fieldset>
                                                <input type="checkbox" name="checkLists" id="checkbox_${tableList.listenGuidelineId}" value="${tableList.listenGuidelineId}" class="check-box-element" >
                                            </fieldset>
                                        </display:column>
                                        <display:column property="title" titleKey="label.guideline.title" sortable="true" sortName="title" />
                                        <display:column headerClass="col-actions" titleKey="label.actions">
                                            ...
                                            <a class="btn btn-sm btn-primary btn-edit" href="${editUrl}" data-toggle="tooltip" title="<fmt:message key='label.guideline.listen.edit' bundle='${lang}' />"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                        </display:column>
                                    </display:table>
                                </fmt:bundle>
                            </div>
