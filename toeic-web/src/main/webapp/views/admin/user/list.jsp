                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            ...
                                            <a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" href="${importUserUrl}"/>
                                                <span>
                                                    <i class="fa fa-file bigger-110 purple" aria-hidden="true"></i>
                                                </span>
                                            </a>
                                        </div>
                                    </div>
        ...
        function addOrEditUser() {
            ...
            $('#editUserForm').submit( function (e) {
                ...
                $.ajax({
                    ...
                    data : $(this).serialize(), //Truyen (Nhan) tat ca cac gia tri cua form len server
                    dataType: 'html', //Kieu du lieu ma server tra ve
